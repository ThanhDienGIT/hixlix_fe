...
function AddBOSetting(props) {
    ...
    const handleAddBOSetting = async () => {
        const objectSend = {
            TEN_BO: BO.TEN_BO,
            DIEMTU: BO.DIEMTU,
            DENDIEM: BO.DENDIEM
        ...
        setLoading(true)
        await Axios.post('addBOSetting', objectSend)
            .then((res) => {
