...
function EditServiceQuality(props) {
    ...
    const handleEditQuality = async () => {
        ...
        setLoading(true)
        await Axios.post('updateServiceQuality/' + props.idquality, objectSend)
            .then((res) => {
    ...
    const CallAPIByidquality = async (id) => {
        await Axios.get('getServiceQualityByID/' + id).then(res => {
            setQuality(res.data)
...
export default EditServiceQuality