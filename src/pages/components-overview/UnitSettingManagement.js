...
import LocalitySetting from 'pages/component/LocalitySetting'

function UnitSettingManagement() {
    ...
    return (
        <ComponentSkeleton>
            <MainCard title="CẤU HÌNH ĐỊA BÀN QUẢN LÝ CỦA ĐƠN VỊ">
                {loadingInitial ?
                            ...
                            <Table size='small'>
                                <TableHead sx={{ backgroundColor: '#0099ff' }} >
                                    <TableRow>
                                        ...
                                        <TableCell sx={{ color: 'white' }}> Địa bàn quản lý</TableCell>
                                    ...
                                    {data ? data.map((ele, index) => (
                                        <React.Fragment key={index}>
                                            <TableRow>
                                                ...
                                                <TableCell>
                                                    <Tooltip title="Cấu hình địa bàn quản lý">
                                                        <IconButton>
                                                            <SettingsIcon color='info' onClick={() => openDialogQuality(ele.DONVI_ID)} />
                                                        </IconButton>
                                                    </Tooltip>
                                                            ...
                                                            <Table size="small" aria-label="purchases">
                                                                <TableBody>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <TableCell>Địa bàn quản lý</TableCell>
                                                                    ...
                                                                    {childUnit ? childUnit.filter(child => Number(child.DONVICHA) === Number(ele.DONVI_ID)).map((child) => (
                                                                        <TableRow key={child.DONVI_ID}>
                                                                            ...
                                                                            <TableCell>
                                                                                {child.dia_ban_quan_ly}
                                                                            </TableCell>
                                                                            <TableCell colSpan={2}>
                                                                                <Tooltip title="Cấu hình địa bàn quản lý">
                                                                                    <IconButton>
                                                                                        <SettingsIcon color='info' onClick={() => openDialogQuality(child.DONVI_ID)} />
                                                                                    </IconButton>
                                                                                </Tooltip>
...
export default UnitSettingManagement
